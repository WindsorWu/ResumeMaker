  ...
  return (
    <div className={`${
      ...
      {avatar ? (
        ...
        <div className={`rounded-full bg-gray-100 border-3 border-gray-200 flex items-center justify-center ${
          isTopBottomLayout 
          ...
          <User className={`text-gray-400 ${
            isTopBottomLayout 
              ? 'h-10 w-10 print:h-8 print:w-8' 
              : 'h-12 w-12 print:h-8 print:w-8'
          }`} />
        </div>
      )}
      ...
      {!isTopBottomLayout && (
        <>
          <h1 className="text-2xl font-bold text-gray-800 mb-3 print:text-lg print:mb-2">{name || '姓名'}</h1>
